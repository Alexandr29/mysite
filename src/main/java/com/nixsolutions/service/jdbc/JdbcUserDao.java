...
public class JdbcUserDao extends AbstractJdbcDao implements UserDao {
    ...
    private final String DELETE_QUERY = "DELETE FROM User WHERE user_id=?";
    private final String SELECT_ALL_QUERY = "SELECT * FROM User left join Role on user.role_id = Role.role_id";
    private final String SELECT_BY_LOGIN_QUERY = "SELECT * FROM User WHERE login=?";
    private final String SELECT_BY_EMAIL_QUERY = "SELECT * FROM User WHERE email=?";
    private final String SELECT_BY_ID_QUERY = "SELECT * FROM User WHERE user_id=?";
    ...
    private User findByParameter(Object parameter, String query) {
        Connection connection = null;
        try {
            connection = createConnection();
